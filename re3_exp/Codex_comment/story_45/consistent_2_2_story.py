...
class World:
    ...
    def story(self):
        ## Nina is working on a school project.
        self.Nina_Harman.occupation.append('student')
        ## It's late afternoon, and Karen wants to just lay back and relax for a few minutes before she goes home.
        self.Karen_Hartman.occupation.append('student')
        self.Karen_Hartman.appearance.append('tired')
        ## Instead, she is stuck in her room helping her friend who isn't exactly an expert when it comes to organization.
