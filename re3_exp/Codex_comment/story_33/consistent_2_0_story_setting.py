...
class World:
    ...
    def story(self):
        ...
        self.Charles_Wilson.relations['investigate Nina'] = 'Nina_Peterson'
        ## He's in his forties and has a wife and two kids at home.
        ...
        self.Charles_Wilson.occupation.append('tendency to flirt with the women')
        ## Nina Peterson is a young woman in her early twenties.
        ...
        self.Nina_Peterson.appearance.append('generally a good person')
        ## Jeff Foster is the man who Nina meets at the bar and brings home with her.
        self.Jeff_Foster.relations['Nina'] = 'Nina_Peterson'
        ## He's in his early thirties and is of average height with dark hair and eyes.
