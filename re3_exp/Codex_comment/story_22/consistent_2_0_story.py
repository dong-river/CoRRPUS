...
class World:
    ...
    def story(self):
        ## Harold Martinez, a 19 year old Hispanic boy, was working at the gas station when he noticed a customer, who looked like he needed some help.
        self.Harold_Martinez.age.append('19 years old')
        ...
        ## "Hey you!"
        ## The customer yelled.
        self.David_Garcia.appearance.append('yelled')
        ## "Don't move!"
        ## Harold stepped out from behind the counter and got on his knees.
        self.Harold_Martinez.appearance.append('got on his knees')
        ## The customer grabbed him by the collar of his shirt and pulled him close to him.
        self.David_Garcia.appearance.append('grabbed him by the collar')
        ## "Listen very carefully," He said in a whisper that was almost a growl, "Give me all the money from the register and nobody gets hurt."
        self.David_Garcia.appearance.append('listen very carefully')
        self.David_Garcia.appearance.append('whisper')
        self.David_Garcia.appearance.append('growl')
        self.David_Garcia.appearance.append('give me all the money from the register')
        ## He pulled out a stack of twenty dollar bills from his pocket and set them on the counter.
        self.David_Garcia.appearance.append('twenty dollar bills')
        ## He had some long greasy hair that stuck out everywhere on his head.
        self.David_Garcia.appearance.append('long greasy hair')
