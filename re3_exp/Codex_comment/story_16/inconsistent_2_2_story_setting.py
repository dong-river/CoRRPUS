...
class World:
    ...
    def story(self):
        ...
        self.Jennifer_Ann_Smith.occupation.append('office building')
        self.Jennifer_Ann_Smith.occupation.append('downtown Chicago')
        self.Jennifer_Ann_Smith.occupation.append('Illinois')
        self.Jennifer_Ann_Smith.occupation.append('United States of America')
        ...
        self.Clara_Smith.age.append('50s')
        ...
        self.Robert_Smith.age.append('60s')
