...
class World:
    ...
    def story(self):
        ...
        self.Olivia_Fria_Spierings.occupation.append('drafted into the army')
        ## She is a small, skinny girl with long dark hair and blue eyes.
        ...
        self.Colonel_Damien_Riggs.relations['commanded'] = 'Olivia_Fria_Spierings'
        ## He is a tall, muscular man in his early 40s with short graying hair and blue eyes.
        ...
        self.Colonel_Damien_Riggs.age.append('early 40s')
