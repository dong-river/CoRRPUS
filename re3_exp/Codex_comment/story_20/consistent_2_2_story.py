...
class World:
    ...
    def story(self):
        ...
        ## This girl made him uncomfortable for some reason, and he wasn't quite sure why.
        ## He didn't like pretty young girls with long dark hair and blue eyes whose slender arms were covered in tattoos from their fingertips all the way up to their shoulders including one with bird wings wrapped around them from shoulder to shoulder that he found particularly interesting (though he couldn't explain why).
        self.Colonel_Damien_Riggs.appearance.append("pretty young girls")
        self.Colonel_Damien_Riggs.appearance.append("long dark hair")
        self.Colonel_Damien_Riggs.appearance.append("blue eyes")
        self.Colonel_Damien_Riggs.appearance.append("slender arms")
        self.Colonel_Damien_Riggs.appearance.append("tattoos")
        self.Colonel_Damien_Riggs.appearance.append("bird wings")
        self.Colonel_Damien_Riggs.appearance.append("shoulder to shoulder")
        self.Colonel_Damien_Riggs.appearance.append("particular interesting")
