...
class World:
    ...
    def story(self):
        ...
        ## She is small for her age, and is often rebel without a cause.
        self.Jenny_Anderson.appearance.append('small for her age')
        self.Jenny_Anderson.personality.append('rebel without a cause')
        ## Jimmy Jackson is Jenny's best friend.
        ...
        ## He is always up for a good time, and is always trying to get Jenny into trouble.
        self.Jimmy_Jackson.personality.append('always up for a good time')
        self.Jimmy_Jackson.personality.append('always trying to get Jenny into trouble')
        ## Principal Stevens is the principal of Jenny's school.
        ...
        ## He is a fair and just man, but is also very strict.
        self.Principal_Stevens.personality.append('fair and just')
        self.Principal_Stevens.personality.append('strict')
