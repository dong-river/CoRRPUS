...
class World:
    ...
    def story(self):
        ...
        ## She has long, brown hair and blue eyes.
        self.Shannon_Kincaid.appearance.append('long, brown hair and blue eyes')
        ## She is of average height and build.
        self.Shannon_Kincaid.appearance.append('average height and build')
        ## Jack Kincaid is Shannon’s father.
        ...
        ## He is a middle-aged man with graying hair and a mustache.
        self.Mark_Woodbury.appearance.append('middle-aged man with graying hair and a mustache')
