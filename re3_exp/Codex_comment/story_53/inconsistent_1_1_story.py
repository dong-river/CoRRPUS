...
class World:
    ...
    def story(self):
        ...
        self.Jessica_Brown.age.append('young')
        ...
        self.Mister_Snuggles.appearance.append('orange')
        ...
        self.Jessica_Brown.appearance.append('blue eyes')
        self.Jane_Doe.appearance.append('blue pajamas')
        self.Jessica_Brown.appearance.append('blue pajamas')
        ...
        self.Jane_Doe.appearance.append('peaceful')
