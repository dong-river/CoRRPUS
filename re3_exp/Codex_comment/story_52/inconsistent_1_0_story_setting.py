...
class World:
    ...
    def story(self):
        ...
        self.John_Mason.relations['best_friend_husband'] = 'Mark_Stephenson'
        self.John_Mason.relations['children'] = ['child_1', 'child_2']
        ...
        self.Sarah_Mason.relations['best_friend_husband'] = 'Mark_Stephenson'
        self.Sarah_Mason.relations['children'] = ['child_1', 'child_2']
        ...
        self.Rachel_Stephenson.relations['children'] = ['child_1', 'child_2']
        ## She is also the mother of two children.
        ## John Mason is Sarah's husband and the father of two children.
        ## He is a successful businessman who has a wandering eye.
