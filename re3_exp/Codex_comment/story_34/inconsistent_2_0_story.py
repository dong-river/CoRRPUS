...
class World:
    ...
    def story(self):
        ...
        ## They'd searched the town thoroughly, but they hadn't been able to find any sign of the killer.
        ## It was driving them crazy, but there wasn't much they could do except watch and wait.
        self.Thomas_Watkins.appearance.append("squinted")
        self.Thomas_Watkins.appearance.append("surveyed the darkness")
        self.Thomas_Watkins.appearance.append("small town")
        self.Thomas_Watkins.appearance.append("24 hours")
        self.Thomas_Watkins.appearance.append("tired")
        self.Thomas_Watkins.appearance.append("thoroughly searched")
        self.Thomas_Watkins.appearance.append("no sign of killer")
        self.Thomas_Watkins.appearance.append("crazy")
        self.Thomas_Watkins.appearance.append("watch and wait")
        ## Thomas was a big man with brown hair and brown eyes.
        ## He stood at 6'2" and had a muscular build.
        ...
        self.Thomas_Watkins.appearance.append("6'2\"")
        self.Thomas_Watkins.appearance.append("muscular")
        ## He normally worked as a construction worker, but he also moonlighted as a mercenary on nights like this one.
        self.Thomas_Watkins.occupation.append("construction worker")
        self.Thomas_Watkins.occupation.append("mercenary")
        ## His skills were in high demand among local towns that needed help protecting themselves from violent criminals or people that wanted to invade their territory or business interests.
        self.Thomas_Watkins.occupation.append("high demand")
        self.Thomas_Watkins.occupation.append("local towns")
        self.Thomas_Watkins.occupation.append("protect themselves")
        self.Thomas_Watkins.occupation.append("violent criminals")
        self.Thomas_Watkins.occupation.append("people that wanted to invade")
        self.Thomas_Watkins.occupation.append("territory")
        self.Thomas_Watkins.occupation.append("business interests")
        ## Thomas was armed with a .357 Magnum revolver, an M-16 machine gun, grenades, and an Uzi machine pistol.
        self.Thomas_Watkins.occupation.append(".357 Magnum revolver")
        self.Thomas_Watkins.occupation.append("M-16 machine gun")
        self.Thomas_Watkins.occupation.append("grenades")
        self.Thomas_Watkins.occupation.append("Uzi machine pistol")
        ## He looked over at his young partner Will Trenton and nodded toward the main street of town in front of them.
        self.Thomas_Watkins.relations['young partner'] = 'Will_Trenton'
