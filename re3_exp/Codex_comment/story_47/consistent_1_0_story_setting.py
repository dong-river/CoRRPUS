...
class World:
    ...
    def story(self):
        ...
        ## She is of average height and build, with shoulder-length brown hair and hazel eyes.
        self.Shannon_Burke.appearance.append("average height and build")
        ...
        self.Maxine_Carter.relations['takes under her wing'] = 'Shannon_Burke'
        ## She is in her late forties and is known for her no-nonsense attitude and sharp wit.
        self.Maxine_Carter.age.append('late forties')
        self.Maxine_Carter.appearance.append("no-nonsense attitude and sharp wit")
