...
class World:
    ...
    def story(self):
        ...
        self.Nadia_Kaminski.occupation.append("Mars")
        ## Connor Riley is an engineer who is responsible for the design and construction of the machines that will be used to simulate the trees on Mars.
        self.Connor_Riley.occupation.append("engineer")
        self.Connor_Riley.occupation.append("design")
        self.Connor_Riley.occupation.append("construction")
        self.Connor_Riley.occupation.append("machines")
        self.Connor_Riley.occupation.append("Mars")
        ## Abigail Harper is a doctor who is chosen to be part of the medical team that will be responsible for the health of the astronauts during their stay on Mars.
        self.Abigail_Harper.occupation.append("doctor")
        self.Abigail_Harper.occupation.append("team member")
        self.Abigail_Harper.occupation.append("medical team")
        self.Abigail_Harper.occupation.append("health")
        self.Abigail_Harper.occupation.append("astronauts")
        self.Abigail_Harper.occupation.append("Mars")
