...
class World:
    ...
    def jessica_brown_woke_up_at_her_usual_time(self):
        self.Jessica_Brown.appearance.append('dark brown hair')
        self.Jessica_Brown.appearance.append('brown eyes')
        self.Jessica_Brown.appearance.append('5 foot 6')
        self.Jessica_Brown.appearance.append('medium build')
        self.Jessica_Brown.appearance.append('fair skin')
        self.Jessica_Brown.gender.append('female')
        self.Jessica_Brown.age.append('teenager')
        self.Jessica_Brown.relations['sister'] = 'Jane_Doe'
        self.Jessica_Brown.relations['cat'] = 'Mister_Snuggles'
        self.Jessica_Brown.occupation.append('student')
        self.Jessica_Brown.occupation.append('sister')
        self.Jessica_Brown.occupation.append('daughter')
        self.Jessica_Brown.occupation.append('cat owner')
    ...
    def it_seemed_to_be_unchanged_except_for_her_sister_jane_s_side_of_the_room_which_looked_like_a_bomb_had_hit_it(self):
        self.Jane_Doe.appearance.append('blonde hair')
        self.Jane_Doe.appearance.append('blue eyes')
        self.Jane_Doe.appearance.append('5 foot 4')
        self.Jane_Doe.appearance.append('skinny')
        self.Jane_Doe.gender.append('female')
        self.Jane_Doe.age.append('teenager')
        self.Jane_Doe.relations['sister'] = 'Jessica_Brown'
        self.Jane_Doe.occupation.append('student')
        self.Jane_Doe.occupation.append('sister')
        self.Jane_Doe.occupation.append('daughter')
