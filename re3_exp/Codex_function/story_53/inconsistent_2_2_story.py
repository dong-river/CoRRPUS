...
class World:
    ...
    def she_was_visiting_her_in_her_apartment_that_evening(self):
        self.Jessica_Brown.relations['apartment_visitor'] = 'Jane_Doe'
        self.Jane_Doe.relations['apartment_owner'] = 'Jessica_Brown'

    def they_were_both_sitting_on_the_couch_watching_tv(self):
        self.Jane_Doe.relations['couch_sitter'] = 'Jessica_Brown'
        self.Jessica_Brown.relations['couch_sitter'] = 'Jane_Doe'
