...
class World:
    ...
    def he_is_the_son_of_a_poor_family_in_the_town_and_has_been_involved_in_a_lot_of_trouble_in_his_life(self):
        self.Tommy_Foster.relations['son of a poor family'] = 'Julie_Christensen'
    ...
    def she_is_a_well_respected_member_of_the_community_and_is_very_involved_in_her_church(self):
        self.Beth_Christensen.occupation.append('a well respected member of the community')
        self.Beth_Christensen.occupation.append('very involved in her church')
