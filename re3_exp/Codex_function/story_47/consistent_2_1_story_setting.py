...
class World:
    ...
    def after_the_loss_of_her_father_shannon_is_determined_to_follow_in_his_footsteps_and_become_a_successful_journalist(self):
        ...
        self.Shannon_Burke.relations['sister'] = 'Jenna_Burke'
        ...
        self.Charles_Burke.relations['wife'] = 'Maxine_Carter'
        self.Charles_Burke.relations['daughter'] = 'Jenna_Burke'
        self.Charles_Burke.occupation.append('journalist')
        self.Maxine_Carter.relations['husband'] = 'Charles_Burke'
        self.Maxine_Carter.relations['daughter'] = 'Shannon_Burke'
        self.Maxine_Carter.relations['daughter'] = 'Jenna_Burke'
