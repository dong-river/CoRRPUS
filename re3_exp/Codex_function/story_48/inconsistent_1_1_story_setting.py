...
print(w.Shannon_Fitzgerald.name)
print(w.Shannon_Fitzgerald.age)
print(w.Shannon_Fitzgerald.gender)
print(w.Shannon_Fitzgerald.appearance)
print(w.Shannon_Fitzgerald.occupation)
print(w.Shannon_Fitzgerald.relations)

print(w.Olivia_Kane.name)
print(w.Olivia_Kane.age)
print(w.Olivia_Kane.gender)
print(w.Olivia_Kane.appearance)
print(w.Olivia_Kane.occupation)
print(w.Olivia_Kane.relations)

print(w.Richard_Kane.name)
print(w.Richard_Kane.age)
print(w.Richard_Kane.gender)
print(w.Richard_Kane.appearance)
print(w.Richard_Kane.occupation)
print(w.Richard_Kane.relations)
