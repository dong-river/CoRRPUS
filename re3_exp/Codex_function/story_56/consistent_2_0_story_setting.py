...
class World:
    ...
    def story(self):
        ...
        self.leah_white_is_karen_s_grandmother()
        self.she_is_in_her_early_seventies_and_is_quite_frail()
        self.she_has_short_graying_hair_and_green_eyes()
    ...
    def she_is_in_her_early_fifties_and_is_quite_ill(self):
        self.Janice_Smith.age.append('middle aged')
        self.Janice_Smith.appearance.append('ill')
    def she_has_short_graying_hair_and_blue_eyes(self):
        self.Janice_Smith.appearance.append('short hair')
        self.Janice_Smith.appearance.append('blue eyes')
    def leah_white_is_karen_s_grandmother(self):
        self.Leah_White.relations['granddaughter'] = 'Karen_Smith'
    def she_is_in_her_early_seventies_and_is_quite_frail(self):
        self.Leah_White.age.append('old')
        self.Leah_White.appearance.append('frail')
    def she_has_short_graying_hair_and_green_eyes(self):
        self.Leah_White.appearance.append('short hair')
