...
class World:
    ...
    def a_girl_is_juggling_her_job_her_schoolwork_and_her_ailing_mother(self):
        self.Karen_Smith.occupation.append('student')
        self.Karen_Smith.occupation.append('employee')
    ...
    def karen_smith_is_a_young_woman_in_her_early_twenties(self):
        self.Karen_Smith.age.append('young')
        self.Karen_Smith.age.append('adult')
    ...
    def janice_smith_is_karen_s_mother(self):
        self.Karen_Smith.relations['mother'] = 'Janice_Smith'
        self.Janice_Smith.relations['daughter'] = 'Karen_Smith'
        self.Janice_Smith.age.append('adult')
    ...
    def leah_white_is_karen_s_grandmother(self):
        self.Karen_Smith.relations['grandmother'] = 'Leah_White'
        self.Leah_White.relations['granddaughter'] = 'Karen_Smith'
        self.Leah_White.age.append('elderly')
