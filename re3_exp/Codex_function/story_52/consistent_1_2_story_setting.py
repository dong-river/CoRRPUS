...
class World:
    ...
    def she_is_the_wife_of_john_mason_and_the_mother_of_two_children(self):
        self.Sarah_Mason.relations['wife'] = 'John_Mason'
        self.Sarah_Mason.relations['mother'] = 'two children'
        self.John_Mason.relations['husband'] = 'Sarah_Mason'
        self.John_Mason.relations['father'] = 'two children'
    ...
    def rachel_stephenson_is_sarah_s_best_friend_and_the_wife_of_mark_stephenson(self):
        ...
        self.Rachel_Stephenson.relations['wife'] = 'Mark_Stephenson'
        self.Rachel_Stephenson.relations['mother'] = 'two children'
