...
class World:
    ...
    def she_has_never_been_married_and_does_not_have_any_children(self):
        self.Payton_Dupree.relations['husband'] = 'none'
    ...
    def she_was_a_stay_at_home_mom_and_died_suddenly_leaving_behind_her_4_year_old_daughter_olivia(self):
        self.Amanda_Dupree.relations['husband'] = 'none'
        self.Amanda_Dupree.relations['children'] = 'Olivia_Dupree'
        self.Amanda_Dupree.occupation.append('stay_at_home_mom')
