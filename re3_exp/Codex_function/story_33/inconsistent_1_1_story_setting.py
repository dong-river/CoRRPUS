...
class World:
    ...
    def he_s_generally_a_good_guy_but_he_has_a_bit_of_a_temper(self):
        self.Charles_Wilson.appearance.append('good guy')
        self.Charles_Wilson.appearance.append('temper')
    ...
    def jeff_foster_is_the_man_who_nina_meets_at_the_bar_and_brings_home_with_her(self):
        self.Nina_Peterson.relations['Jeff_Foster'] = 'met at bar'
        self.Jeff_Foster.relations['Nina_Peterson'] = 'met at bar'
...
## Define a world model state to track the appearance, personality, and relations of a group of characters.
