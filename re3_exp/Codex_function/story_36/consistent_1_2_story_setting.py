...
class World:
    ...
    def karen_fletcher_is_a_middle_aged_woman_with_blonde_hair_and_blue_eyes(self):
        self.Karen_Fletcher.appearance.append("middle-aged")
    ...
    def kate_fletcher_is_karen_s_teenage_daughter(self):
        ...
        self.Kate_Fletcher.appearance.append("teenage")
    ...
    def julia_fletcher_is_karen_s_younger_sister(self):
        self.Karen_Fletcher.relations['younger sister'] = 'Julia_Fletcher'
        self.Julia_Fletcher.relations['older sister'] = 'Karen_Fletcher'
