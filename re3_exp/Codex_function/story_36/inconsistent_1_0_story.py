...
class World:
    ...
    def julia_fletcher_had_been_the_only_person_to_witness_the_murder_of_her_daughter_in_law_karen_on_that_fateful_day_in_february(self):
        ...
        self.Karen_Fletcher.relations['daughter_in_law'] = 'Julia_Fletcher'
        self.Julia_Fletcher.relations['daughter_in_law'] = 'Karen_Fletcher'
        self.Julia_Fletcher.relations['mother_in_law'] = 'Karen_Fletcher'
        self.Julia_Fletcher.appearance.append('short')
        self.Julia_Fletcher.appearance.append('brown hair')
        self.Julia_Fletcher.appearance.append('blue eyes')
        self.Julia_Fletcher.age.append('old')
        self.Julia_Fletcher.age.append('frail')
        self.Julia_Fletcher.gender.append('female')
        self.Karen_Fletcher.gender.append('female')
        self.Karen_Fletcher.appearance.append('tall')
        self.Karen_Fletcher.appearance.append('blonde hair')
        self.Karen_Fletcher.appearance.append('blue eyes')
        self.Karen_Fletcher.age.append('young')
        self.Karen_Fletcher.age.append('pretty')
        self.Kate_Fletcher.relations['mother'] = 'Karen_Fletcher'
        self.Kate_Fletcher.relations['grandmother'] = 'Julia_Fletcher'
        self.Kate_Fletcher.gender.append('female')
        self.Kate_Fletcher.appearance.append('short')
        self.Kate_Fletcher.appearance.append('brown hair')
        self.Kate_Fletcher.appearance.append('blue eyes')
        self.Kate_Fletcher.age.append('young')
        self.Kate_Fletcher.age.append('pretty')
    def ever_since_then_she_has_been_on_a_constant_watch_for_karen_s_ghost_and_sees_her_shadow_sometimes(self):
        self.Karen_Fletcher.relations['shadow'] = 'Julia_Fletcher'
        self.Julia_Fletcher.relations['shadow'] = 'Karen_Fletcher'
