...
class World:
    ...
    def nina_harman_is_a_small_delicate_looking_pre_teen_with_long_dark_hair_and_brown_eyes(self):
        self.Nina_Harman.age.append('pre_teen')
    ...
    def jake_ryan_is_a_handsome_teenage_boy_who_is_popular_at_school(self):
        self.Jake_Ryan.age.append('teen')
        self.Jake_Ryan.appearance.append('handsome')
    def he_is_athletic_and_outgoing_but_can_be_arrogant_at_times(self):
        self.Jake_Ryan.occupation.append('athletic')
        self.Jake_Ryan.occupation.append('outgoing')
        self.Jake_Ryan.occupation.append('arrogant')
    ...
    def karen_hartman_is_nina_s_best_friend_who_is_outgoing_and_energetic_with_a_quick_wit_and_sharp_tongue(self):
        ...
        self.Karen_Hartman.occupation.append('outgoing')
        self.Karen_Hartman.occupation.append('energetic')
        self.Karen_Hartman.occupation.append('quick_wit')
        self.Karen_Hartman.occupation.append('sharp_tongue')
