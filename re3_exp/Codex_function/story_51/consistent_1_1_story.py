...
class World:
    ...
    def john_doe_sat_at_his_desk_staring_out_the_window(self):
        self.John_Doe.appearance.append("dark blue eyes")
        self.John_Doe.appearance.append("brown hair")
        self.John_Doe.appearance.append("thin")
        self.John_Doe.appearance.append("5'9''")
        self.John_Doe.appearance.append("wears glasses")
        self.John_Doe.appearance.append("wears a suit")
        self.John_Doe.occupation.append("salesman")
        self.John_Doe.gender.append("male")
        self.John_Doe.age.append("25")
        ...
        self.Mike_Benson.age.append("40")
        self.Abby_Mills.gender.append("female")
        self.Abby_Mills.age.append("23")
        self.Abby_Mills.appearance.append("brown hair")
        self.Abby_Mills.appearance.append("thin")
        self.Abby_Mills.appearance.append("5'7''")
        self.Abby_Mills.appearance.append("wears glasses")
        self.Abby_Mills.occupation.append("waitress")
