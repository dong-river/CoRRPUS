...
class World:
    ...
    def the_story_is_set_in_a_gas_station_at_night(self):
        pass
    def harold_martinez_is_a_young_hispanic_man_who_is_the_gas_station_attendant_who_is_held_up_at_gunpoint_by_a_customer_and_is_forced_to_give_him_all_the_money_in_the_register(self):
