...
class World:
    ...
    def story(self):
        ...
        self.chase_elliott_is_a_tall_handsome_man_in_his_early_thirties()
        self.he_has_dark_hair_and_blue_eyes()
        self.he_is_the_chief_of_police_in_the_small_town_where_riley_has_moved_to()
    ...
    def after_the_death_of_her_father_a_young_woman_moves_to_a_small_town_to_start_a_new_life(self):
        ...
        self.Riley_Harper.relations['moves to'] = 'small town'
        self.Jonas_Harper.relations['died in'] = 'car accident'
    def she_quickly_learns_that_the_town_is_full_of_secrets_and_that_her_father_s_death_may_not_have_been_an_accident(self):
        self.Riley_Harper.relations['learns about'] = 'secrets'
        self.Riley_Harper.relations['learns about'] = 'fathers death'
    ...
    def chase_elliott_is_a_tall_handsome_man_in_his_early_thirties(self):
        self.Chase_Elliott.gender.append('male')
        self.Chase_Elliott.age.append('young')
        self.Chase_Elliott.appearance.append('tall')
        self.Chase_Elliott.appearance.append('handsome')
    def he_has_dark_hair_and_blue_eyes(self):
        self.Chase_Elliott.appearance.append('dark hair')
        self.Chase_Elliott.appearance.append('blue eyes')
    def he_is_the_chief_of_police_in_the_small_town_where_riley_has_moved_to(self):
