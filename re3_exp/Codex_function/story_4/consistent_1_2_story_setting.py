...
print(w.Shannon_Kincaid.name)
print(w.Shannon_Kincaid.appearance)
print(w.Shannon_Kincaid.age)
print(w.Shannon_Kincaid.gender)
print(w.Shannon_Kincaid.occupation)
print(w.Shannon_Kincaid.relations)

print(w.Jack_Kincaid.name)
print(w.Jack_Kincaid.appearance)
print(w.Jack_Kincaid.age)
print(w.Jack_Kincaid.gender)
print(w.Jack_Kincaid.occupation)
print(w.Jack_Kincaid.relations)

print(w.Mark_Woodbury.name)
print(w.Mark_Woodbury.appearance)
print(w.Mark_Woodbury.age)
print(w.Mark_Woodbury.gender)
print(w.Mark_Woodbury.occupation)
print(w.Mark_Woodbury.relations)
