...
class World:
    ...
    def their_dad_s_light_was_on_and_olivia_saw_a_strange_shadow_moving_behind_their_parents_open_door(self):
        self.Olivia_Saunders.relations['dad'] = 'Jackson_Cooper'
        self.Emma_Saunders.relations['dad'] = 'Jackson_Cooper'
...
## Create a world model state and track each character's appearance, personality, and relations with other characters.
