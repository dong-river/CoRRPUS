...
class World:
    ...
    def their_dad_s_light_was_on_and_olivia_saw_a_strange_shadow_moving_behind_their_parents_open_door(self):
        self.Olivia_Saunders.relations['father'] = 'Jackson_Cooper'
        self.Emma_Saunders.relations['father'] = 'Jackson_Cooper'
        self.Jackson_Cooper.relations['daughters'] = ['Olivia_Saunders', 'Emma_Saunders']
    def dad(self):
        pass
