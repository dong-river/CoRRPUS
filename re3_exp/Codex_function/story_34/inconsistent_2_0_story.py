...
class World:
    ...
    def he_stood_at_6_2_and_had_a_muscular_build(self):
        ...
        self.Thomas_Watkins.appearance.append('6 foot 2 inches')
    ...
    def thomas_was_armed_with_a_357_magnum_revolver_an_m_16_machine_gun_grenades_and_an_uzi_machine_pistol(self):
        self.Thomas_Watkins.appearance.append('armed with 357 magnum revolver')
        self.Thomas_Watkins.appearance.append('armed with m-16 machine gun')
        self.Thomas_Watkins.appearance.append('armed with grenades')
        self.Thomas_Watkins.appearance.append('armed with uzi machine pistol')
    def he_looked_over_at_his_young_partner_will_trenton_and_nodded_toward_the_main_street_of_town_in_front_of_them(self):
        ...
        self.Will_Trenton.age.append('young')
