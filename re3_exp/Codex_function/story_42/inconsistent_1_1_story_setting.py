...
class World:
    ...
    def she_s_been_told_her_whole_life_that_she_s_going_to_be_a_great_doctor_just_like_her_mother(self):
        self.Valerie_Russo.relations['mother'] = 'Antoinette Russo'
        self.Antoinette_Russo.relations['daughter'] = 'Valerie Russo'
    ...
    def carl_russo_is_valerie_s_father(self):
        self.Valerie_Russo.relations['father'] = 'Carl Russo'
        self.Carl_Russo.relations['daughter'] = 'Valerie Russo'
