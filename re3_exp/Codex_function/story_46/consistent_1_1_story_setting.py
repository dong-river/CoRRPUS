...
class World:
    ...
    def story(self):
        ...
        self.tina_sanchez_is_a_28_year_old_latina_who_works_as_a_stylist()
        self.she_is_short_and_curvaceous_with_long_dark_hair_and_brown_eyes()
    def a_young_woman_fresh_out_of_college_moves_to_new_york_city_to_start_her_dream_job_but_discovers_that_the_reality_of_working_in_the_fashion_industry_is_far_different_from_what_she_expected(self):
        ...
        self.Jessica_Campbell.occupation.append('fashion')
    ...
    def she_is_tall_and_thin_with_long_blond_hair_and_blue_eyes(self):
        ...
        self.Jessica_Campbell.appearance.append('blond')
        self.Jessica_Campbell.appearance.append('blue')
    ...
    def he_is_tall_and_handsome_with_short_brown_hair_and_blue_eyes(self):
        ...
        self.John_Smith.appearance.append('brown')
        self.John_Smith.appearance.append('blue')
    def tina_sanchez_is_a_28_year_old_latina_who_works_as_a_stylist(self):
        self.Tina_Sanchez.age.append('28')
        self.Tina_Sanchez.gender.append('female')
        self.Tina_Sanchez.occupation.append('stylist')
    def she_is_short_and_curvaceous_with_long_dark_hair_and_brown_eyes(self):
        self.Tina_Sanchez.appearance.append('short')
        self.Tina_Sanchez.appearance.append('curvaceous')
        self.Tina_Sanchez.appearance.append('dark')
        self.Tina_Sanchez.appearance.append('brown')
