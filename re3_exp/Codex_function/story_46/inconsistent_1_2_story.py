...
class World:
    ...
    def it_was_a_bright_sunny_morning_and_her_stylist_rachel_cunningham_stood_next_to_her_brushing_out_tina_s_long_black_hair(self):
        self.Tina_Sanchez.relations['stylist'] = 'Rachel_Cunningham'
        self.Rachel_Cunningham = character('Rachel Cunningham')
        self.Rachel_Cunningham.relations['client'] = 'Tina_Sanchez'
