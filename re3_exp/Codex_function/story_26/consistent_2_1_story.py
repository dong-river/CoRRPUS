...
class World:
    ...
    def she_didn_not_want_to_bother_bob_and_mary_so_she_decided_to_drive_over_to_the_hanson_residence(self):
        ...
        self.Karen_Hanson.relations['niece'] = 'Lettie_Hanson'
    ...
    def when_she_looked_up_karen_saw_that_her_eyes_were_blackened_and_red_from_crying_so_much(self):
        self.Lettie_Hanson.appearance.append('blackened and red from crying')
...
## Create a world model state to track the setting, characters, and their relationships.
