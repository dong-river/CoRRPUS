...
class World:
    ...
    def she_is_29_years_old_and_was_killed_in_a_car_accident_approximately_a_year_ago(self):
        self.Payton_Parskin.age.append("29 years old")
        self.Payton_Parskin.age.append("approximately a year ago")
    def landon_shaw_is_a_30_year_old_man_who_was_payton_s_fiancé_at_the_time_of_her_death(self):
        self.Landon_Shaw.age.append("30 years old")
        self.Payton_Parskin.relations['fiancé'] = 'Landon_Shaw'
        self.Landon_Shaw.relations['fiancée'] = 'Payton_Parskin'
    ...
    def maggie_shaw_is_landon_s_sister_and_payton_s_best_friend(self):
        self.Maggie_Shaw.relations['sister'] = 'Landon_Shaw'
    ...
    def she_is_25_years_old_and_works_as_a_teacher(self):
        self.Maggie_Shaw.age.append("25 years old")
        self.Maggie_Shaw.occupation.append("teacher")

world_model = World()
world_model.story()

print(world_model.Payton_Parskin.appearance)
print(world_model.Payton_Parskin.age)
print(world_model.Payton_Parskin.relations)
print(world_model.Landon_Shaw.age)
print(world_model.Landon_Shaw.occupation)
print(world_model.Landon_Shaw.relations)
print(world_model.Maggie_Shaw.age)
print(world_model.Maggie_Shaw.occupation)
print(world_model.Maggie_Shaw.relations)
