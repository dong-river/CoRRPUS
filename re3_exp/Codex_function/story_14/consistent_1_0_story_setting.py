...
print(world.Jenny_Anderson.relations)

print(world.Jimmy_Jackson.relations)

print(world.Principal_Stevens.relations)

print(world.Jenny_Anderson.appearance)

print(world.Jimmy_Jackson.appearance)

print(world.Principal_Stevens.appearance)
