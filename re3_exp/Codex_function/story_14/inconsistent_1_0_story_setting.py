...
class World:
    ...
    def he_is_always_up_for_a_good_time_and_is_always_trying_to_get_jenny_into_trouble(self):
        self.Jimmy_Jackson.appearance.append("always up for a good time")

    def principal_stevens_is_the_principal_of_jenny_s_school(self):
        self.Jenny_Anderson.relations['school principal'] = 'Principal_Stevens'
        self.Principal_Stevens.relations['principal of'] = 'Jenny_Anderson'
    ...
    def he_is_a_fair_and_just_man_but_is_also_very_strict(self):
        ...
        self.Principal_Stevens.appearance.append("very strict")

## Generate a story by calling the world model state's story method.

# create a world model state
world = World()
