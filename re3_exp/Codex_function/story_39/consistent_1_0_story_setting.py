...
class World:
    ...
    def story(self):
        ...
        self.connor_riley_is_an_engineer_who_is_responsible_for_the_design_and_construction_of_the_machines_that_will_be_used_to_simulate_the_trees_on_mars()
    ...
    def she_is_chosen_to_be_part_of_the_team_that_is_sent_to_mars_to_investigate_the_possibility_of_life_there(self):
        self.Nadia_Kaminski.relations['part_of_team'] = 'Mars_Team'
    def connor_riley_is_an_engineer_who_is_responsible_for_the_design_and_construction_of_the_machines_that_will_be_used_to_simulate_the_trees_on_mars(self):
    ...
    def abigail_harper_is_a_doctor_who_is_chosen_to_be_part_of_the_medical_team_that_will_be_responsible_for_the_health_of_the_astronauts_during_their_stay_on_mars(self):
        ...
        self.Abigail_Harper.relations['part_of_team'] = 'Mars_Team'
