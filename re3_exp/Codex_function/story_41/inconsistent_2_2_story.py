...
class World:
    ...
    def alex_preston_is_now_a_ghost_and_he_watches_as_jennie_gets_out_of_her_wrecked_car(self):
        self.Alex_Preston.relations['Jennie_Mayfield'] = 'friend'
        self.Jennie_Mayfield.relations['Alex_Preston'] = 'friend'
    ...
    def her_body_is_athletic(self):
        self.Jennie_Mayfield.appearance.append('athletic body')
