...
class World:
    ...
    def they_were_in_his_new_car_alex_driving_and_jennie_in_the_passenger_seat(self):
        self.Alex_Preston.relations['passenger'] = 'Jennie_Mayfield'
        self.Jennie_Mayfield.relations['driver'] = 'Alex_Preston'
    ...
    def however_they_had_to_stay_behind_as_the_police_dealt_with_the_other_driver_who_was_arrested_for_reckless_driving(self):
        self.Alex_Preston.relations['other_driver'] = 'Aaron_Mayfield'
        self.Aaron_Mayfield.relations['driver'] = 'Alex_Preston'

    def they_watched_from_a_distance_as_paramedics_took_care_of_people_from_both_cars_involved_in_the_accident(self):
        self.Alex_Preston.relations['paramedic'] = 'Aaron_Mayfield'
        self.Aaron_Mayfield.relations['paramedic'] = 'Alex_Preston'
