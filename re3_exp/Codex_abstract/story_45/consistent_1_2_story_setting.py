...
class World:
    ...
    def story(self):
        ## The story is set in a small town in the United States.
        ## Nina Harman is a small, delicate looking pre-teen with long dark hair and brown eyes.
        self.set_appearance(self.Nina_Harman, "small, delicate")
        ...
        ## She is shy and withdrawn, but has a kind heart.
        self.set_appearance(self.Nina_Harman, "shy")
        self.set_appearance(self.Nina_Harman, "withdrawn")
        self.set_appearance(self.Nina_Harman, "kind heart")
        ## Jake Ryan is a handsome teenage boy who is popular at school.
        self.set_appearance(self.Jake_Ryan, "handsome")
        self.set_age(self.Jake_Ryan, "teenage")
        self.set_occupation(self.Jake_Ryan, "popular")
        ## He is athletic and outgoing, but can be arrogant at times.
        self.set_appearance(self.Jake_Ryan, "athletic")
        self.set_appearance(self.Jake_Ryan, "outgoing")
        self.set_appearance(self.Jake_Ryan, "arrogant")
        ## He is also Nina's crush.
        ...
        ## She is a kind and loving woman who is always supportive of her daughter.
        self.set_appearance(self.Karen_Hartman, "kind")
        self.set_appearance(self.Karen_Hartman, "loving")
        self.set_appearance(self.Karen_Hartman, "supportive")
