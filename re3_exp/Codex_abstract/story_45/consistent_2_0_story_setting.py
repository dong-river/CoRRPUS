...
class World:
    ...
    def story(self):
        ...
        self.set_appearance(self.Karen_Hartman, "outgoing")
        self.set_appearance(self.Karen_Hartman, "energetic")
        self.set_appearance(self.Karen_Hartman, "quick wit")
        self.set_appearance(self.Karen_Hartman, "sharp tongue")
