...
class World:
    ...
    def story(self):
        ## Olivia Dupree is now 5 years old.
        self.set_age(self.Olivia_Dupree, "5 years old")
        ## Her mother Amanda died suddenly five years ago, and she was left in the care of her godmother Payton.
        self.set_relation(self.Amanda_Dupree, 'mother', self.Olivia_Dupree)
        self.set_relation(self.Olivia_Dupree, 'daughter', self.Amanda_Dupree)
        self.set_relation(self.Payton_Dupree, 'godmother', self.Olivia_Dupree)
