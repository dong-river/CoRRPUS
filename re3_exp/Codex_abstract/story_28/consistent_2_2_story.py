...
class World:
    ...
    def story(self):
        ...
        ## Amanda knelt down on one knee and embraced her daughter in a tight hug.
        self.set_appearance(self.Amanda_Dupree, "kneeled down on one knee")
        ## "Olivia, you have to go.
        ## Your Aunt Payton is very busy and can't take care of you right now," Amanda said softly.
        self.set_relation(self.Payton_Dupree, 'sister', self.Amanda_Dupree)
        self.set_relation(self.Amanda_Dupree, 'sister', self.Payton_Dupree)
