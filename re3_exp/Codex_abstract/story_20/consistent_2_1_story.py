...
class World:
    ...
    def story(self):
        ...
        self.set_occupation(self.Colonel_Damien_Riggs, "Colonel")
        ...
        ## This girl made him uncomfortable for some reason, and he wasn't quite sure why.
        ## He didn't like pretty young girls with long dark hair and blue eyes whose slender arms were covered in tattoos from their fingertips all the way up to their shoulders including one with bird wings wrapped around them from shoulder to shoulder that he found particularly interesting (though he couldn't explain why).
        self.set_appearance(self.Colonel_Damien_Riggs, "half-closed eyes")
        self.set_appearance(self.Colonel_Damien_Riggs, "pretty young girls")
        self.set_appearance(self.Colonel_Damien_Riggs, "long dark hair")
        self.set_appearance(self.Colonel_Damien_Riggs, "blue eyes")
        self.set_appearance(self.Colonel_Damien_Riggs, "slender arms")
        self.set_appearance(self.Colonel_Damien_Riggs, "tattoos")
        self.set_appearance(self.Colonel_Damien_Riggs, "bird wings")
        self.set_appearance(self.Colonel_Damien_Riggs, "shoulder")
        self.set_appearance(self.Colonel_Damien_Riggs, "interesting")
        self.set_appearance(self.Colonel_Damien_Riggs, "couldn't explain why")
