...
print(world.Olivia_Fria_Spierings.appearance)
print(world.Olivia_Fria_Spierings.relations)
print(world.Olivia_Fria_Spierings.occupation)
print(world.Olivia_Fria_Spierings.age)

print(world.Colonel_Damien_Riggs.relations)
