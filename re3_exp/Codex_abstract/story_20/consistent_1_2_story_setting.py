...
class World:
    ...
    def story(self):
        ...
        ## Colonel Damien Riggs is the commanding officer of Olivia's unit.
        self.set_relation(self.Olivia_Fria_Spierings, 'commander', self.Colonel_Damien_Riggs)
        self.set_relation(self.Colonel_Damien_Riggs, 'commanded', self.Olivia_Fria_Spierings)
        ## He is a tall, muscular man in his early 40s with short graying hair and blue eyes.
        self.set_gender(self.Colonel_Damien_Riggs, "male")
        self.set_age(self.Colonel_Damien_Riggs, "early 40s")
        self.set_appearance(self.Colonel_Damien_Riggs, "tall, muscular man")
        self.set_appearance(self.Colonel_Damien_Riggs, "short graying hair and blue eyes")
