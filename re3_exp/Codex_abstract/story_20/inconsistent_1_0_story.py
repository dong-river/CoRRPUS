...
class World:
    ...
    def story(self):
        ## Olivia Fria Spierings was marching down the hallway when Colonel Damien Riggs's aide called her into his office.
        self.set_occupation(self.Olivia_Fria_Spierings, "soldier")
        self.set_occupation(self.Colonel_Damien_Riggs, "soldier")
        self.set_relation(self.Olivia_Fria_Spierings, 'superior', self.Colonel_Damien_Riggs)
        self.set_relation(self.Colonel_Damien_Riggs, 'subordinate', self.Olivia_Fria_Spierings)
        ## She knew what was coming.
        ## She was short and skinny with long dark hair, blue eyes, and a pretty face.
        ...
        self.set_appearance(self.Olivia_Fria_Spierings, "covered in tattoos")
