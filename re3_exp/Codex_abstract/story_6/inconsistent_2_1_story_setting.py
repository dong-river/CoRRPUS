...
class World:
    ...
    def story(self):
        ...
        ## She is of average height and build.
        self.set_appearance(self.Shannon_Riley, "average height")
        self.set_appearance(self.Shannon_Riley, "average build")
        ## Robert Riley is Shannon's father.
        ...
        self.set_appearance(self.Robert_Riley, "died suddenly of a heart attack")
        ## Jillian Riley is Shannon's older sister by three years.
        self.set_age(self.Jillian_Riley, "older sister by three years")
        self.set_gender(self.Jillian_Riley, "female")
        ## She is a successful corporate lawyer who lives and works in the city.
        self.set_occupation(self.Jillian_Riley, "corporate lawyer")
        self.set_appearance(self.Jillian_Riley, "lives and works in the city")
        ## After the loss of her father, Shannon is determined to follow in his footsteps and become a successful journalist.
