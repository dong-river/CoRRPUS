...
class World:
    ...
    def story(self):
        ...
        ## exclaimed Shannon.
        ## "Robert Riley hired me."
        self.set_relation(self.Shannon_Riley, 'employer', self.Robert_Riley)
        self.set_relation(self.Robert_Riley, 'employee', self.Shannon_Riley)
        ## Jillian choked on her soup.
        ## "What?"
        ## she asked incredulously when she'd recovered herself.
        ## "You're not going to work for Robert Riley!"
        ...
        ## Apparently, Shannon hadn't known either.
        ## She just assumed that Robert had moved back to the city and was living off his retirement fund while taking care of his two granddaughters full-time.
        self.set_relation(self.Robert_Riley, 'father', self.Jillian_Riley)
        self.set_relation(self.Jillian_Riley, 'father', self.Robert_Riley)
        self.set_relation(self.Robert_Riley, 'granddaughters', self.Jillian_Riley)
