...
class World:
    ...
    def story(self):
        ...
        ## Apparently, Shannon hadn't known either.
        ## She just assumed that Robert had moved back to the city and was living off his retirement fund while taking care of his two granddaughters full-time.
        self.set_relation(self.Jillian_Riley, 'father', self.Robert_Riley)
        self.set_relation(self.Robert_Riley, 'daughter', self.Jillian_Riley)
        ...
        self.set_relation(self.Shannon_Riley, 'grandfather', self.Robert_Riley)
        self.set_relation(self.Robert_Riley, 'granddaughter', self.Shannon_Riley)
        self.set_relation(self.Jillian_Riley, 'grandfather', self.Robert_Riley)
        self.set_relation(self.Robert_Riley, 'granddaughter', self.Jillian_Riley)
