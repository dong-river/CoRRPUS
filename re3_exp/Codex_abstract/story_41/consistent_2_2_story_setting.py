...
class World:
    ...
    def story(self):
        ...
        self.set_age(self.Jennie_Mayfield, "twenties")
        ## She has long dark hair and brown eyes.
        ...
        ## He is in his late twenties and has short blond hair and blue eyes.
        self.set_age(self.Aaron_Mayfield, "twenties")
        ...
        self.set_relation(self.Alex_Preston, 'best friend', self.Aaron_Mayfield)
        self.set_relation(self.Aaron_Mayfield, 'best friend', self.Alex_Preston)
        self.set_age(self.Alex_Preston, "young")
        self.set_age(self.Alex_Preston, "twenties")
