...
class World:
    ...
    def story(self):
        ...
        self.set_relation(self.Shannon_Mulaney, 'child', self.Shannon_Mulaney)
        ## Jess Abernathy is a 21-year-old student at XYZ University and Shannon's RA.
        ...
        self.set_relation(self.Jess_Abernathy, 'oldest', self.Jess_Abernathy)
        ## Olivia Kendall is Shannon's best friend from high school who is also attending XYZ University with her.
        self.set_relation(self.Shannon_Mulaney, 'friend', self.Olivia_Kendall)
        self.set_relation(self.Olivia_Kendall, 'friend', self.Shannon_Mulaney)
        ## Olivia is of average height with wavy brown hair and hazel eyes.
