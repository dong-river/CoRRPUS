...
class World:
    ...
    def story(self):
        ...
        ## Her mom hadn't let go of life after losing Shannon's dad when Shannon was 9, so she kept busy, going here and there until late at night, rarely taking care of Shannon.
        self.set_relation(self.Shannon_Mulaney, 'father', self.Olivia_Kendall)
        ...
        self.set_age(self.Shannon_Mulaney, "many years")
        self.set_appearance(self.Shannon_Mulaney, "lonely")
