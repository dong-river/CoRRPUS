...
class World:
    ...
    def story(self):
        ...
        ## The story is set in a hospital room.
        ## Karen Fletcher is a middle-aged woman with blonde hair and blue eyes.
        self.set_appearance(self.Karen_Fletcher, "blonde hair and blue eyes")
        self.set_age(self.Karen_Fletcher, "middle-aged")
        ## She is of average height and build.
        self.set_appearance(self.Karen_Fletcher, "average height and build")
        ## Kate Fletcher is Karen's teenage daughter.
        ...
        ## She is tall and slender with dark hair and brown eyes.
        self.set_appearance(self.Kate_Fletcher, "tall and slender")
        self.set_appearance(self.Kate_Fletcher, "dark hair and brown eyes")
        ## Julia Fletcher is Karen's mother-in-law who is in her late 60s/early 70s, thin and frail with grey hair and blue eyes, Julia is bedridden and uses a wheelchair to get around.
        ...
        self.set_appearance(self.Julia_Fletcher, "thin and frail")
        self.set_appearance(self.Julia_Fletcher, "grey hair and blue eyes")
        self.set_appearance(self.Julia_Fletcher, "bedridden and uses a wheelchair to get around")
