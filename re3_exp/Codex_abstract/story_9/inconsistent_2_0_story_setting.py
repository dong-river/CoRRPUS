...
class World:
    ...
    def story(self):
        ...
        ## He is the son of a poor family in the town, and has been involved in a lot of trouble in his life.
        self.set_occupation(self.Tommy_Foster, "poor")
        ## Tommy is Julie's boyfriend, and the father of her unborn child.
        ...
        self.set_relation(self.Julie_Christensen, 'sister', self.Beth_Christensen)
        self.set_relation(self.Beth_Christensen, 'sister', self.Julie_Christensen)
