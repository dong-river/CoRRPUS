...
class World:
    ...
    def story(self):
        ...
        ## He is the son of a poor family in the town, and has been involved in a lot of trouble in his life.
        self.set_relation(self.Tommy_Foster, 'son', self.Tommy_Foster)
        self.set_relation(self.Tommy_Foster, 'poor_family', self.Tommy_Foster)
        ## Tommy is Julie's boyfriend, and the father of her unborn child.
        ...
        self.set_relation(self.Julie_Christensen, 'unborn_child', self.Tommy_Foster)
        ## Beth Christensen is Julie's best friend since childhood and her confidante in this matter.
        self.set_relation(self.Julie_Christensen, 'best_friend', self.Beth_Christensen)
        self.set_relation(self.Beth_Christensen, 'best_friend', self.Julie_Christensen)
        self.set_relation(self.Julie_Christensen, 'confidante', self.Beth_Christensen)
        self.set_relation(self.Beth_Christensen, 'confidante', self.Julie_Christensen)
