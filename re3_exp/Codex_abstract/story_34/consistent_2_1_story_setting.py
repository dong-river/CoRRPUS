...
class World:
    ...
    def story(self):
        ...
        ## Amanda Wilkinson is a local woman who is terrified of the serial killer.
        ## She's been living in fear for months and is ready to do whatever it takes to protect herself.
        self.set_relation(self.Amanda_Wilkinson, 'local', self.Thomas_Watkins)
        self.set_relation(self.Thomas_Watkins, 'local', self.Amanda_Wilkinson)
        ## Thomas Watkins is the sheriff of the small town.
        ## He's a good man who wants to protect his people, but he's out of his depth when it comes to the serial killer.
        self.set_relation(self.Thomas_Watkins, 'sheriff', self.Amanda_Wilkinson)
        self.set_relation(self.Amanda_Wilkinson, 'sheriff', self.Thomas_Watkins)
        self.set_relation(self.Thomas_Watkins, 'sheriff', self.Will_Trenton)
        self.set_relation(self.Will_Trenton, 'sheriff', self.Thomas_Watkins)
