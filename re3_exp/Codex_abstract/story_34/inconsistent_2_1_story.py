...
class World:
    ...
    def story(self):
        ...
        ## They'd searched the town thoroughly, but they hadn't been able to find any sign of the killer.
        ## It was driving them crazy, but there wasn't much they could do except watch and wait.
        self.set_relation(self.Thomas_Watkins, 'team', self.Will_Trenton)
        self.set_relation(self.Thomas_Watkins, 'team', self.Amanda_Wilkinson)
        ## Thomas was a big man with brown hair and brown eyes.
        self.set_appearance(self.Thomas_Watkins, "brown hair")
        self.set_appearance(self.Thomas_Watkins, "brown eyes")
        self.set_appearance(self.Thomas_Watkins, "big man")
        ## He stood at 6'2" and had a muscular build.
        self.set_appearance(self.Thomas_Watkins, "6'2''")
        self.set_appearance(self.Thomas_Watkins, "muscular build")
        ## He normally worked as a construction worker, but he also moonlighted as a mercenary on nights like this one.
