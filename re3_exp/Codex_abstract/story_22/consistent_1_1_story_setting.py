...
class World:
    ...
    def story(self):
        ...
        ## He is armed and dangerous, and is clearly desperate.
        ## Create a function to print the world model state.
 
    def print_world(self):
        print("Characters:")
        print("\t" + self.Harold_Martinez.name + ":")
        print("\t\tAppearance: " + str(self.Harold_Martinez.appearance))
        print("\t\tOccupation: " + str(self.Harold_Martinez.occupation))
        print("\t\tGender: " + str(self.Harold_Martinez.gender))
        print("\t\tAge: " + str(self.Harold_Martinez.age))
        print("\t\tRelations: " + str(self.Harold_Martinez.relations))
        print("\t" + self.David_Garcia.name + ":")
        print("\t\tAppearance: " + str(self.David_Garcia.appearance))
        print("\t\tOccupation: " + str(self.David_Garcia.occupation))
        print("\t\tGender: " + str(self.David_Garcia.gender))
        print("\t\tAge: " + str(self.David_Garcia.age))
        print("\t\tRelations: " + str(self.David_Garcia.relations))
