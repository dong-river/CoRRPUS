...
class World:
    ...
    def story(self):
        ...
        self.set_gender(self.Rachel_Stephenson, "female")
        ...
        self.set_age(self.Sarah_Mason, "young")
        self.set_age(self.Rachel_Stephenson, "middle-aged")
        self.set_age(self.John_Mason, "middle-aged")
        self.set_appearance(self.Rachel_Stephenson, "blue eyes") 
        self.set_appearance(self.John_Mason, "brown eyes") 
        self.set_appearance(self.Sarah_Mason, "brown eyes") 
        self.set_occupation(self.John_Mason, "doctor")
        self.set_occupation(self.Rachel_Stephenson, "nurse")
        self.set_occupation(self.Sarah_Mason, "student")
