...
class World:
    ...
    def story(self):
        ...
        self.set_relation(self.Rachel_Stephenson, 'daughter', self.Sarah_Mason)
        self.set_relation(self.Sarah_Mason, 'mother', self.Rachel_Stephenson)
        self.set_relation(self.John_Mason, 'daughter', self.Sarah_Mason)
        self.set_relation(self.Sarah_Mason, 'father', self.John_Mason)
        self.set_age(self.Rachel_Stephenson, "adult")
        ...
        ## She had two wonderful children, Jonathan and Cynthia.
        self.set_relation(self.John_Mason, 'son', self.Sarah_Mason)
        self.set_relation(self.Sarah_Mason, 'father', self.John_Mason)
        self.set_relation(self.Rachel_Stephenson, 'son', self.Sarah_Mason)
        self.set_relation(self.Sarah_Mason, 'mother', self.Rachel_Stephenson)
        self.set_age(self.Sarah_Mason, "child")
