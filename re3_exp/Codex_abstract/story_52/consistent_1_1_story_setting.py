...
class World:
    ...
    def story(self):
        ...
        self.set_relation(self.Sarah_Mason, 'children', self.John_Mason)
        self.set_relation(self.John_Mason, 'children', self.Sarah_Mason)
        ## Rachel Stephenson is Sarah's best friend and the wife of Mark Stephenson.
        ...
        ## She is also the mother of two children.
        self.set_relation(self.Rachel_Stephenson, 'children', self.John_Mason)
        self.set_relation(self.John_Mason, 'children', self.Rachel_Stephenson)
        ## John Mason is Sarah's husband and the father of two children.
        self.set_relation(self.Sarah_Mason, 'husband', self.John_Mason)
        self.set_relation(self.John_Mason, 'wife', self.Sarah_Mason)
        self.set_relation(self.John_Mason, 'children', self.Sarah_Mason)
