...
class World:
    ...
    def story(self):
        ...
        self.set_relation(self.Sarah_Mason, 'mother', self.John_Mason)
        self.set_relation(self.John_Mason, 'father', self.Sarah_Mason)
        ## Rachel Stephenson is Sarah's best friend and the wife of Mark Stephenson.
        ...
        ## She is also the mother of two children.
        self.set_relation(self.Rachel_Stephenson, 'mother', self.John_Mason)
        self.set_relation(self.John_Mason, 'father', self.Rachel_Stephenson)
        ## John Mason is Sarah's husband and the father of two children.
