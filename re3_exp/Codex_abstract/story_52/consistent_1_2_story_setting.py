...
class World:
    ...
    def story(self):
        ...
        self.set_relation(self.John_Mason, 'best_friend', self.Rachel_Stephenson)
        self.set_relation(self.Rachel_Stephenson, 'best_friend', self.John_Mason)
        ...
        self.set_relation(self.John_Mason, 'wife', self.Sarah_Mason)
        ## Rachel Stephenson is Sarah's best friend and the wife of Mark Stephenson.
        self.set_relation(self.Rachel_Stephenson, 'wife', self.Sarah_Mason)
        self.set_relation(self.Sarah_Mason, 'best_friend', self.Rachel_Stephenson)
        ## She is also the mother of two children.
        ## John Mason is Sarah's husband and the father of two children.
