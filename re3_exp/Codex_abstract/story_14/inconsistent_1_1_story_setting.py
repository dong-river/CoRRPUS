...
class World:
    ...
    def story(self):
        ...
        self.set_appearance(self.Jimmy_Jackson, "lanky")
        self.set_appearance(self.Jimmy_Jackson, "dark hair")
        self.set_appearance(self.Jimmy_Jackson, "brown eyes")
        ## He is always up for a good time, and is always trying to get Jenny into trouble.
        self.set_appearance(self.Jimmy_Jackson, "always up for a good time")
        ## Principal Stevens is the principal of Jenny's school.
        ...
        ## He is a fair and just man, but is also very strict.
        self.set_appearance(self.Principal_Stevens, "fair and just")
