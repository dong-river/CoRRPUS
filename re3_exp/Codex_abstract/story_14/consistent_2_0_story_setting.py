...
class World:
    ...
    def story(self):
        ...
        self.set_appearance(self.Jenny_Anderson, "rebel without a cause")
        ## Jimmy Jackson is Jenny's boyfriend and the star quarterback of the football team at their school..
        ...
        self.set_relation(self.Jenny_Anderson, 'student', self.Principal_Stevens)
        ## He is a middle-aged man with graying hair and glasses.
        self.set_appearance(self.Principal_Stevens, "middle-aged man with graying hair and glasses")
