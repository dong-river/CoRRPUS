...
class World:
    ...
    def story(self):
        ...
        ## She is chosen to be part of the team that is sent to Mars to investigate the possibility of life there.
        self.set_occupation(self.Nadia_Kaminski, "team")
        self.set_occupation(self.Nadia_Kaminski, "Mars")
        self.set_occupation(self.Nadia_Kaminski, "investigate")
        ## Connor Riley is an astronaut who is chosen to be the pilot of the spaceship that will take the team to Mars.
        self.set_occupation(self.Connor_Riley, "astronaut")
        self.set_occupation(self.Connor_Riley, "pilot")
        self.set_occupation(self.Connor_Riley, "spaceship")
        self.set_occupation(self.Connor_Riley, "team")
        self.set_occupation(self.Connor_Riley, "Mars")
        ## Abigail Harper is a doctor who is chosen to be part of the medical team that will be responsible for the health of the astronauts during their stay on Mars.
        self.set_occupation(self.Abigail_Harper, "doctor")
        self.set_occupation(self.Abigail_Harper, "medical team")
        self.set_occupation(self.Abigail_Harper, "health")
        self.set_occupation(self.Abigail_Harper, "astronauts")
        self.set_occupation(self.Abigail_Harper, "Mars")
