...
class World:
    ...
    def story(self):
        ...
        ## She is chosen to be part of the team that is sent to Mars to investigate the possibility of life there.
        ## Connor Riley is an astronaut who is chosen to be the pilot of the spaceship that will take the team to Mars.
        self.set_occupation(self.Connor_Riley, 'astronaut')
        self.set_gender(self.Connor_Riley, 'male')
        ## Abigail Harper is a doctor who is chosen to be part of the medical team that will be responsible for the health of the astronauts during their stay on Mars.
        self.set_occupation(self.Abigail_Harper, 'doctor')
        self.set_gender(self.Abigail_Harper, 'female')
        ## The team is sent to Mars in a spaceship that is equipped with everything they need to survive.
        ## They land on Mars and begin to explore the planet.
        ## They find a cave and decide to explore it.
        ## They find a strange plant that seems to be emitting oxygen.
        ## They take a sample of the plant and bring it back to the spaceship.
        ## They analyze the plant and find that it is actually producing oxygen.
        ## They decide to take some of the plants back to Earth with them.
        ## They return to Earth and give the plants to the government.
        ## The government decides to plant the plants all over the world.
        ## The plants produce enough oxygen to make the air breathable again.
        ## The humans are able to survive.
