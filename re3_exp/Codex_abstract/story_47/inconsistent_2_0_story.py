...
class World:
    ...
    def story(self):
        ...
        self.set_gender(self.Charles_Burke, "male")
        self.set_gender(self.Maxine_Carter, "female")
        self.set_relation(self.Shannon_Burke, 'husband', self.Charles_Burke)
        self.set_relation(self.Charles_Burke, 'wife', self.Shannon_Burke)
        self.set_relation(self.Shannon_Burke, 'boss', self.Maxine_Carter)
        self.set_relation(self.Maxine_Carter, 'employee', self.Shannon_Burke)
        self.set_appearance(self.Shannon_Burke, "wild look")
        self.set_appearance(self.Shannon_Burke, "surprised look")
        self.set_appearance(self.Shannon_Burke, "smiling broadly")
        self.set_appearance(self.Shannon_Burke, "laughing nervously")
        self.set_appearance(self.Shannon_Burke, "nervous babble")
        self.set_appearance(self.Shannon_Burke, "checking watch")
        self.set_appearance(self.Shannon_Burke, "peeking through blinds")
