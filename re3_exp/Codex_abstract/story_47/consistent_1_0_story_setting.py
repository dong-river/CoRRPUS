...
class World:
    ...
    def story(self):
        ...
        self.set_appearance(self.Shannon_Burke, "average build")
        self.set_appearance(self.Shannon_Burke, "shoulder-length brown hair")
        self.set_appearance(self.Shannon_Burke, "hazel eyes")
        ## Charles Burke is Shannon's father.
        ## He was a successful journalist who died unexpectedly a few years ago.
        self.set_occupation(self.Charles_Burke, "successful journalist")
        ## Maxine Carter is a veteran reporter who takes Shannon under her wing at the news station.
        self.set_relation(self.Shannon_Burke, 'veteran reporter', self.Maxine_Carter)
        self.set_relation(self.Maxine_Carter, 'young reporter', self.Shannon_Burke)
        ## She is in her late forties and is known for her no-nonsense attitude and sharp wit.
        self.set_age(self.Maxine_Carter, "late forties")
        self.set_gender(self.Maxine_Carter, "female")
        self.set_appearance(self.Maxine_Carter, "no-nonsense attitude")
        self.set_appearance(self.Maxine_Carter, "sharp wit")
