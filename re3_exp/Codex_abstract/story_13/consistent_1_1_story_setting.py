...
class World:
    ...
    def story(self):
        ## The story is set in the present day in a small town in the midwest.
        ## Sherry Hellinger is a middle-aged woman with short brown hair and green eyes.
        self.set_appearance(self.Sherry_Hellinger, "short brown hair and green eyes")
        self.set_age(self.Sherry_Hellinger, "middle-aged")
        ## She is of average height and build.
        self.set_appearance(self.Sherry_Hellinger, "average height and build")
        ## Emily Hellinger is Sherry's wife of ten years.
        ...
        ## She is a tall woman with long blond hair and blue eyes.
        self.set_appearance(self.Emily_Hellinger, "tall woman with long blond hair and blue eyes")
        ## She is in her early 40s.
        ...
        ## He is a tall man with short brown hair and blue eyes.
        self.set_appearance(self.John_Hellinger, "tall man with short brown hair and blue eyes")
        ## He is in his early 40s.
