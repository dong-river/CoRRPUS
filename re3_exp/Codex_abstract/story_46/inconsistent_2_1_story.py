...
class World:
    ...
    def story(self):
        ## Tina Sanchez sat behind the mirror in her large dressing room, dabbing makeup on a young model’s face.
        self.set_relation(self.Tina_Sanchez, 'dressing room', self.Jessica_Campbell)
        self.set_relation(self.Jessica_Campbell, 'dressing room', self.Tina_Sanchez)
        ...
        self.set_appearance(self.Tina_Sanchez, "perfectly applied makeup")
        self.set_appearance(self.Tina_Sanchez, "perfectly matched")
        self.set_appearance(self.Tina_Sanchez, "perfectly understated")
        self.set_appearance(self.Tina_Sanchez, "incredibly chic")
        self.set_occupation(self.Tina_Sanchez, "New York fashion industry")
        self.set_occupation(self.Tina_Sanchez, "stylist")
        self.set_occupation(self.Jessica_Campbell, "model")
