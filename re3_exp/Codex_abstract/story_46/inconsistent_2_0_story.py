...
class World:
    ...
    def story(self):
        ...
        self.set_relation(self.Tina_Sanchez, 'young model', self.Jessica_Campbell)
        ...
        self.set_appearance(self.Tina_Sanchez, "shoes")
        self.set_appearance(self.Tina_Sanchez, "perfectly understated and incredibly chic")
