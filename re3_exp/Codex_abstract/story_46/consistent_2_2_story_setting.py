...
class World:
    ...
    def story(self):
        ...
        self.set_occupation(self.Jessica_Campbell, "college")
        ## She is tall and thin, with long blond hair and blue eyes.
        self.set_appearance(self.Jessica_Campbell, "tall and thin")
        ...
        ## He is tall and handsome, with short brown hair and blue eyes.
        self.set_appearance(self.John_Smith, "tall and handsome")
        ...
        self.set_age(self.Tina_Sanchez, "22")
        self.set_occupation(self.Tina_Sanchez, "model")
        ## She is short and thin, with long black hair and brown eyes.
        self.set_appearance(self.Tina_Sanchez, "short and thin")
