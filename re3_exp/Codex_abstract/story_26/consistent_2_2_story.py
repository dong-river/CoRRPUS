...
class World:
    ...
    def story(self):
        ...
        ## (The door had been jammed ever since Bob's last attempt.)
        ## Karen was sure that was where Lettie would be right now.
        self.set_relation(self.Bob_Hanson, 'workshop', self.Bob_Hanson)
        self.set_relation(self.Bob_Hanson, 'workshop', self.Lettie_Hanson)
        self.set_relation(self.Lettie_Hanson, 'workshop', self.Bob_Hanson)
        self.set_relation(self.Lettie_Hanson, 'workshop', self.Lettie_Hanson)
        ## She burst into the room and found Lettie curled up on the bed sobbing.
        ## When she looked up, Karen saw that her eyes were blackened and red from crying so much.
