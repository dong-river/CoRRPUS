...
class World:
    ...
    def story(self):
        ...
        self.set_age(self.Chase_Elliott, "young")
        self.set_occupation(self.Chase_Elliott, "works at the local gas station")
        ## He has dark hair and brown eyes and is of average height and build."
        self.set_appearance(self.Chase_Elliott, "dark hair")
        self.set_appearance(self.Chase_Elliott, "brown eyes")
        self.set_appearance(self.Chase_Elliott, "average height")
        self.set_appearance(self.Chase_Elliott, "average build")
        ## Jonas Harper is Riley's late father.
        ...
        self.set_occupation(self.Jonas_Harper, "died suddenly in a car accident")
