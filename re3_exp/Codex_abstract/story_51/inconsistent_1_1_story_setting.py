...
class World:
    ...
    def story(self):
        ...
        self.set_appearance(self.John_Doe, "tall")
        self.set_appearance(self.John_Doe, "handsome")
        ## He has dark hair and eyes and is usually clean-shaven.
        self.set_appearance(self.John_Doe, "dark hair")
        self.set_appearance(self.John_Doe, "dark eyes")
        self.set_appearance(self.John_Doe, "clean-shaven")
        ## He works as a salesperson for a local company.
        self.set_occupation(self.John_Doe, "salesperson")
        ## Abby Mills is a beautiful woman in her early 30s.
