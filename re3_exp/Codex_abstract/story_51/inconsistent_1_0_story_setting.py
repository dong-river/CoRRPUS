...
class World:
    ...
    def story(self):
        ## The story is set in a small town in the US.
        ## John Doe is a tall, handsome man in his early 30s.
        self.set_appearance(self.John_Doe, "tall, handsome")
        self.set_age(self.John_Doe, "early 30s")
        self.set_gender(self.John_Doe, "male")
        ## He has dark hair and eyes and is usually clean-shaven.
        self.set_appearance(self.John_Doe, "dark hair and eyes")
        ## He works as a salesperson for a local company.
        ...
        ## She has blonde hair and blue eyes.
        self.set_appearance(self.Abby_Mills, "blonde hair and blue eyes")
        ## She is a teacher at a local elementary school.
